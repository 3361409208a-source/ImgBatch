...
| On Primary | `#F8FFFE` | `--color-on-primary` |
| Secondary | `#334155` | `--color-secondary` |
| Accent/CTA | `#0D9488` | `--color-accent` |
| Background | `#F1F3F6` | `--color-background` |
| Foreground | `#0F172A` | `--color-foreground` |
| Muted | `#E8ECF1` | `--color-muted` |
| Muted FG | `#64748B` | `--color-muted-fg` |
| Border | `#D5DBE3` | `--color-border` |
| Destructive | `#B91C1C` | `--color-destructive` |
| Ring | `#0F766E` | `--color-ring` |
| Surface | `#FFFFFF` | `--color-surface` |

**Color Notes:** Slate + teal — professional image-tool look (no purple/pink)

### Typography

- **UI Font:** Manrope
- **Mono Font:** JetBrains Mono
- **Mood:** precise, dense, desktop utility
